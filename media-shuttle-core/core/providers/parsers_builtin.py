...
def builtin_parse_providers(mode: str) -> list[ParseProvider]:
    ...
    if mode == "live":
        providers.extend(
            [
                ...
                ParseProvider("cyberdrop_live", "live", is_cyberdrop, parse_cyberdrop_live),
                ParseProvider("filester_live", "live", is_filester, parse_filester_live),
                ParseProvider("fileditchfiles_live", "live", is_fileditchfiles, parse_fileditchfiles_live),
    ...
    providers.extend(
        [
            ...
            ParseProvider("filester", "mock", is_filester, parse_filester),
            ParseProvider("fileditchfiles", "mock", is_fileditchfiles, parse_fileditchfiles),
            ...
            ParseProvider("transfer", "mock", is_transfer, parse_transfer),
            ParseProvider("turbo", "mock", is_turbo, parse_turbo),
